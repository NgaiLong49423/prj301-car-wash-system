...
<title>AquaSmart - Trang ch? R?a xe Thông minh</title>
...
<a class="font-label-md text-label-md text-on-surface-variant dark:text-surface-variant hover:text-primary transition-colors" href="#">?u ?ãi</a>
</nav>
</div>
...
<div class="space-y-2">
<h1 class="font-headline-lg text-headline-lg text-on-background">Chào m?ng tr? l?i, <%= c.getFullName() %></h1>
<p class="font-body-md text-body-md text-on-surface-variant">Hôm nay là m?t ngày tuy?t v?i ?? làm s?ch "x? yêu" c?a b?n!</p>
</div>
...
<div>
<p class="font-label-sm text-label-sm text-on-surface-variant">T?ng ??n hàng</p>
...
<div>
<p class="font-label-sm text-label-sm text-on-surface-variant">?i?m tích l?y</p>
...
<span class="px-3 py-1 bg-white/20 rounded-full font-label-sm text-label-sm backdrop-blur-md mb-4 inline-block">Tr?ng thái hi?n t?i</span>
<h2 class="font-headline-lg text-headline-lg mb-2">Xe c?a b?n ?ang ? giai ?o?n: S?y khô</h2>
<p class="font-body-md text-body-md text-primary-fixed">??c tính hoàn thành sau: 5 phút</p>
</div>
...
<h3 class="font-headline-md text-headline-md text-on-surface">Mã Nh?n Xe</h3>
<p class="font-body-md text-body-md text-on-surface-variant px-4">S? d?ng mã này t?i tr?m khi xe hoàn t?t ?? nh?n xe nhanh chóng.</p>
...
<p class="text-on-surface-variant text-[13px] mb-4">Làm s?ch ngo?i th?t tiêu chu?n</p>
<div class="flex justify-between items-center">
...
<h3 class="font-label-md text-label-md mb-1">?ánh Bóng Cao C?p</h3>
...
<p class="text-on-surface-variant text-[13px] mb-4">Hút b?i và di?t khu?n 99%</p>
<div class="flex justify-between items-center">
...
<p class="text-on-surface-variant text-[13px] mb-4">T?y r?a khoang máy chuyên sâu</p>
<div class="flex justify-between items-center">
...
<div class="flex justify-between items-center">
<h2 class="font-headline-md text-headline-md text-on-background">L?ch s? G?n ?ây</h2>
</div>
<div class="space-y-4">
<!-- History Item 1 -->
...
<span class="px-2 py-1 rounded-full bg-secondary/10 text-secondary text-[10px] font-bold uppercase">Hoàn t?t</span>
</div>
<!-- History Item 2 -->
<div class="flex items-center gap-4 bg-surface-container-low p-4 rounded-2xl border border-outline-variant hover:bg-surface-container transition-colors cursor-pointer">
<div class="w-12 h-12 bg-surface-container-highest rounded-xl flex items-center justify-center">
...
<div class="relative z-10">
<h4 class="font-headline-md text-headline-md mb-2">Th? Thành Viên Vàng</h4>
<p class="font-body-md text-body-md opacity-80 mb-4">B?n ch? còn 2 l?n r?a n?a ?? nh?n 1 l?n mi?n phí!</p>
