...
<nav class="mb-8 flex items-center gap-2 text-on-surface-variant font-label-bold text-label-bold">
  <a class="hover:text-primary cursor-pointer transition-colors" href="<%= request.getContextPath() %>/MainController?action=Profile">Profile</a>
...
<form id="addVehicleForm" class="space-y-6" method="post" action="<%= request.getContextPath() %>/MainController">
