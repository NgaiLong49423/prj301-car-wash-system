        ...
        <aside class="space-y-6">
            <section class="rounded-lg border border-white/10 bg-[#1a1d21] p-5">
                ...
                <div class="mt-4 space-y-3 text-sm text-slate-300">
                    ...
                    <div class="flex gap-3"><span class="material-symbols-outlined text-blue-200">verified</span> Hạng chỉ ưu tiên hàng chờ, không đẩy lịch đã xác nhận.</div>
                </div>
            </section>
